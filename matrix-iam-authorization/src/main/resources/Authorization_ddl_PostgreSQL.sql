/*==============================================================*/
/* Table: authorization_consumer                                */
/*==============================================================*/
create table authorization_consumer (
    ...
    grant_version        INT4                 not null,
    assign_version       INT4                 not null,
    ...
    constraint PK_AUTHORIZATION_CONSUMER primary key (consumer_id)
);

comment on table authorization_consumer is
'消费端';

comment on column authorization_consumer.consumer_id is
'Primarykey';

comment on column authorization_consumer.consumer_name is
'名称';

comment on column authorization_consumer.grant_version is
'该consumer的subject和role关系变动,值累加';

comment on column authorization_consumer.assign_version is
'该consumer的role_resource_operation关系变动,值累加';

comment on column authorization_consumer.version is
'版本号,可用于乐观锁';

comment on column authorization_consumer.owner is
'属主标识';

comment on column authorization_consumer.creator is
'创建者标识';

comment on column authorization_consumer.create_datetime is
'创建时间,长度6';

comment on column authorization_consumer.modifier is
'最后修改者标识';

comment on column authorization_consumer.modify_datetime is
'最后修改时间,长度6';

comment on column authorization_consumer.summary is
'简述说明';

comment on column authorization_consumer.state is
'状态';

/*==============================================================*/
/* Index: authorization_consumer_PK                             */
/*==============================================================*/
create unique index authorization_consumer_PK on authorization_consumer (
    consumer_id
);
