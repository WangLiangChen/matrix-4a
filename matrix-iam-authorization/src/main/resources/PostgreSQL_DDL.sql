...
comment on column matrix_authorization_operation.operation_dependence is
    '依赖的操作,operation_code以半角分号隔开';

comment on column matrix_authorization_operation.operation_uri is
...
(
    ...
    tenant_code     varchar(36)  not null,
    consumer_code   varchar(36)  not null,
    allowlist_uri  varchar(200) not null,
    version         int4         not null default 0,
    owner           varchar(60)  not null default '',
    creator         varchar(60)  not null default '',
    create_datetime timestamp    not null,
...
comment on column matrix_authorization_allowlist.allowlist_uri is
    '[{"method":"PUT","ant_path":"/account/*"}]';
