...
import wang.liangchen.matrix.iam.authorization.domain.AuthorizationAllowlist;
...
@SpringBootTest
public class AllowlistDaoTest {
    private static final MatrixLogger logger = MatrixLoggerFactory.getLogger(AllowlistDaoTest.class);
    @Inject
